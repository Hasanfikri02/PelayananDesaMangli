...
<main class="flex-1 p-8 overflow-y-auto bg-gray-900 rounded-tl-3xl shadow-inner">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-3xl font-bold text-yellow-400">📄 Edit Kategori Pengaduan</h1>
            <p class="text-gray-300 text-sm">Ubah detail kategori pengaduan warga di sini.</p>
        </div>
    </div>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto bg-white/10 backdrop-blur-md border border-gray-700 rounded-2xl shadow-lg p-8">
            <form action="{{ route('admin.kategori-pengaduan.update', $kategori->id) }}" method="POST">
                ...
                {{-- NAMA KATEGORI --}}
                <div class="mb-6">
                    <label for="nama_kategori" class="block text-gray-200 font-semibold mb-2">
                        Nama Kategori
                    </label>
                    <div class="relative">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4"
                        class="w-full px-4 py-2 border border-gray-600 rounded-xl bg-gray-800 text-gray-100 focus:ring-2 focus:ring-yellow-400 focus:outline-none transition">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
                </div>
