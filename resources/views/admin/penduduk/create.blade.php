    ...
    <div class="p-4 text-sm text-gray-400 border-t border-gray-700">
        ...
        <main class="flex-1 p-8 overflow-y-auto bg-gray-900 rounded-tl-3xl shadow-inner">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-yellow-400 flex items-center gap-2">🧑‍🤝‍🧑 Tambah Penduduk</h1>
                    <p class="text-gray-300 text-sm">Tambahkan data penduduk baru ke sistem sensus desa.</p>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto px-6">
                <div class="bg-white/10 dark:bg-gray-800/60 rounded-2xl shadow-2xl p-10 border border-gray-700 backdrop-blur-md">
                    ...
                    <a href="{{ route('admin.sensuspenduduk.index') }}" class="text-blue-400 mb-6 inline-block">← Kembali</a>
                    ...
                    <form action="{{ route('admin.sensuspenduduk.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}"
                                    class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="hubungan_keluarga" value="{{ old('hubungan_keluarga') }}"
                                    class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="kk_id"
                                    ...
                                    @foreach($kk as $k)
                                        <option value="{{ $k->id }}" {{ old('kk_id')==$k->id ? 'selected' : '' }}>
