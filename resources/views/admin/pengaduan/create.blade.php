    ...
    <div class="flex min-h-screen bg-gray-900 text-gray-100 font-poppins">
        ...
        <main class="flex-1 p-8 overflow-y-auto bg-gray-900 rounded-tl-3xl shadow-inner">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-yellow-400 flex items-center gap-2">📋 Ajukan Pengaduan</h1>
                    <p class="text-gray-300 text-sm">Kelola dan kirim pengaduan warga di sini.</p>
                </div>
            </div>
                    ...
                    <form action="{{ route('admin.pengaduan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="isi_pengaduan" rows="5"
                                class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200"
                                placeholder="Tuliskan isi pengaduan..."></textarea>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <input type="text" name="lokasi"
                                class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200"
                                placeholder="Contoh: Jalan Mawar No. 12">
                        </div>
