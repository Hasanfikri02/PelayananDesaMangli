    ...
    📢 <span>Jenis Pengaduan</span>
        ...
        <main class="flex-1 p-10 overflow-y-auto bg-gray-900 rounded-tl-3xl">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-yellow-400 flex items-center gap-2">👥 Edit Petugas</h1>
                    <p class="text-gray-300 text-sm">Ubah data petugas desa di sini.</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <input type="text" name="nama" value="{{ $petugas->nama }}"
                                       class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="no_hp" value="{{ $petugas->no_hp }}"
                                       class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200">
                            </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="wilayah" value="{{ $petugas->wilayah }}"
                                       class="w-full border border-gray-600 rounded-lg px-4 py-2 text-gray-100 bg-gray-900/50 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:outline-none transition duration-200">
                            </div>
                        </div>
