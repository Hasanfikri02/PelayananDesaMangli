    ...
    📢 <span>Jenis Pengaduan</span>
        ...
        <main class="flex-1 p-8 overflow-y-auto bg-gray-900 rounded-tl-3xl shadow-inner">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-yellow-400">👥 Daftar Petugas</h1>
                    <p class="text-gray-300 text-sm">Kelola data seluruh petugas desa di sini.</p>
                </div>
                    ...
                    <tbody class="divide-y divide-gray-700">
                        @forelse ($petugas as $key => $p)
                            <tr class="hover:bg-gray-700 transition">
                                ...
                                <td class="px-5 py-4 text-gray-300">{{ $p->email }}</td>
                                <td class="px-5 py-4 text-gray-300">{{ $p->no_hp }}</td>
                                <td class="px-5 py-4 text-gray-300">{{ $p->jabatan }}</td>
