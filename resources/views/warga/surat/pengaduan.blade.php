<x-guest-layout>
    <div class="pt-28 max-w-6xl mx-auto px-6 py-10">
        ...
        <div class="text-center mt-16 mb-12">
            <h1 class="text-4xl font-extrabold text-gray-800 mb-2">Pengaduan Warga Desa</h1>
            <p class="text-gray-600 text-lg">Silakan pilih pengaduan sesuai kebutuhan kamu.</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            @foreach ($kategori as $k)
                <div
                    ...
                    <a href="{{ route('warga.pengaduan.form', $k->id) }}"
